...
<template>
    ...
    <div
        class="relative sm:flex sm:justify-start sm:items-start min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="mt-8 mb-8">
            ...
            <div class="ml-48 mr-48 mt-8">
                <div class="mb-2">
                    <select v-model="selectedCategory" class="input-text w-1/6">
                ...
                <div class="rounded-xl overflow-y-auto shadow-lg">
                    <table class="table-fixed text-left w-full">
                        <thead class="text-lg uppercase bg-gray-500 text-white font-bold">
                            <tr>
                                <th scope="col" class="p-4 w-1/5">Votos</th>
                                <th scope="col" class="p-4 w-3/5">Recurso</th>
                                <th scope="col" class="p-4 w-1/5">Categoria</th>
                                <th scope="col" class="p-4 w-1/5">Link</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white">
                            <tr v-for="resource in filteredResources" :key="resource.id">
                                <th scope="row" class="p-4 w-1/3 flex">
